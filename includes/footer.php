        ...
        <div class="container text-md-left">
            <div class="row text-md-left">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 fw-bold text-white" style="border-bottom: 2px solid var(--primary-color); display: inline-block; padding-bottom: 5px;">Quick Links</h5>
                    <p><a href="#home" class="text-white text-decoration-none" style="transition: 0.3s;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='white'">Home</a></p>
                    <p><a href="#why-us" class="text-white text-decoration-none" style="transition: 0.3s;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='white'">Why Choose Us</a></p>
                    <p><a href="#faq" class="text-white text-decoration-none" style="transition: 0.3s;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='white'">FAQs</a></p>
                    <p><a href="#contact" class="text-white text-decoration-none" style="transition: 0.3s;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='white'">Contact Us</a></p>
                </div>

                <!-- Column 3: Categories -->
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 fw-bold text-white" style="border-bottom: 2px solid var(--primary-color); display: inline-block; padding-bottom: 5px;">Our Categories</h5>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p class="mb-3 d-flex align-items-start">
                        <i class="fa-solid fa-location-dot me-3 mt-1" style="color: var(--primary-color);"></i>

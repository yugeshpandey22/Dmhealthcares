    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 text-center rounded-4 overflow-hidden pt-4 doctor-card">
                    <div class="position-relative mx-auto mb-3">
                        <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=300" alt="Sachin Thakur" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid white; box-shadow: 0 10px 20px rgba(0,0,0,0.1);" loading="lazy">
                        <div class="position-absolute bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; bottom: 0; right: 10px; border: 3px solid white;">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 text-center rounded-4 overflow-hidden pt-4 doctor-card">
                    <div class="position-relative mx-auto mb-3">
                        <img src="https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&q=80&w=300" alt="Dr. Sharma" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid white; box-shadow: 0 10px 20px rgba(0,0,0,0.1);" loading="lazy">
                        <div class="position-absolute bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; bottom: 0; right: 10px; border: 3px solid white;">
                            <i class="fa-solid fa-stethoscope fs-6"></i>
                        </div>
                    </div>
                    <div class="card-body px-4 pb-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 text-center rounded-4 overflow-hidden pt-4 doctor-card">
                    <div class="position-relative mx-auto mb-3">
                        <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&q=80&w=300" alt="Dr. Verma" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid white; box-shadow: 0 10px 20px rgba(0,0,0,0.1);" loading="lazy">
                        <div class="position-absolute bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; bottom: 0; right: 10px; border: 3px solid white;">
                            <i class="fa-solid fa-person-walking fs-6"></i>
                        </div>
                    </div>
                    <div class="card-body px-4 pb-4">

<section class="doctors-section py-5" style="background-color: white;" id="doctors">
    <div class="container py-4">
        <div class="text-center mb-5">
            <h2 class="section-title fw-bolder mb-3" style="color: #1a237e; font-size: 2.5rem;">Meet Our Experts</h2>
            <div style="width: 80px; height: 4px; background: var(--secondary-color); margin: 0 auto 20px auto; border-radius: 2px;"></div>
            <p class="section-subtitle text-muted fs-5">Highly qualified medical professionals dedicated to your well-being.</p>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm text-center rounded-4 overflow-hidden pt-4" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small px-3">Leading the vision of providing world-class home healthcare and dedicated medical staffing across the region.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm text-center rounded-4 overflow-hidden pt-4" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small px-3">Over 15 years of experience in critical care and emergency medicine. Oversees all ICU home setups.</p>
                        <div class="d-flex justify-content-center gap-3 mt-3">
                            <a href="#" class="text-secondary fs-5"><i class="fa-brands fa-linkedin"></i></a>
                            <a href="#" class="text-secondary fs-5"><i class="fa-brands fa-twitter"></i></a>
                        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm text-center rounded-4 overflow-hidden pt-4" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small px-3">Specialist in orthopedic and neurological rehabilitation with a focus on fast recovery at home.</p>
                        <div class="d-flex justify-content-center gap-3 mt-3">
                            <a href="#" class="text-secondary fs-5"><i class="fa-brands fa-linkedin"></i></a>
                            <a href="#" class="text-secondary fs-5"><i class="fa-brands fa-twitter"></i></a>
                        </div>

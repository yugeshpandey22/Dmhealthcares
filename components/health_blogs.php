<section class="blogs-section py-5 bg-light" id="blogs">
    <div class="container py-4">
        <div class="text-center mb-5">
            <h2 class="section-title fw-bolder mb-3" style="color: #1a237e; font-size: 2.5rem;">Health Tips & Blogs</h2>
            <div style="width: 80px; height: 4px; background: var(--secondary-color); margin: 0 auto 20px auto; border-radius: 2px;"></div>
            <p class="section-subtitle text-muted fs-5">Stay informed with the latest insights on home care and healthy living.</p>
        </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small">Discover the best diet plans and nutritional foods that help your body heal quickly after a major surgery.</p>
                        <a href="#" class="text-decoration-none fw-bold" style="color: var(--secondary-color);">Read More <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small">Learn essential tips and modifications to make your home safer for elderly family members and prevent accidents.</p>
                        <a href="#" class="text-decoration-none fw-bold" style="color: var(--secondary-color);">Read More <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden" style="transition: 0.3s;" onmouseover="this.classList.add('shadow')" onmouseout="this.classList.remove('shadow')">
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small">Why continuous physiotherapy is crucial for long-term mobility and how you can do simple exercises at home.</p>
                        <a href="#" class="text-decoration-none fw-bold" style="color: var(--secondary-color);">Read More <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>

        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-5">
                ...
                <div class="card bg-light border-0 rounded-3 p-3 mb-3">
                    ...
                    <a href="https://wa.me/919319149644?text=Hi%20DM%20Healthcare,%20I%20urgently%20need%20an%20oxygen%20concentrator." target="_blank" class="btn btn-outline-success rounded-pill fw-bold py-2 btn-sm">
...
<section class="py-4 py-lg-5 bg-white border-top">
    <div class="container">
        ...
        <div class="row g-3 justify-content-center text-center">
            ...
            <div class="col-6 col-md-3">
                <a href="hospital-bed" class="card border rounded-3 p-3 text-decoration-none shadow-sm h-100 bg-light oc-product-card">

        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-4 mb-lg-0">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="tel:+919319149644" class="btn btn-danger btn-lg fw-bold px-4 rounded-pill shadow-sm" style="background: var(--primary-color); border-color: var(--primary-color);">
